  ...
  return (
    <div id="experience" className="py-16 bg-gray-100 dark:bg-gray-950">
      ...
      <div 
        ...
        className="relative px-6 max-w-4xl mx-auto">
        {/* Timeline Line */}
          ...
          {experiences.map((item, index) => (
            ...
            >
              ...
              <div className="ml-16 md:ml-0 md:w-[calc(50%-2rem)]">
                <div className="bg-white dark:bg-green-950 shadow-md rounded-xl p-6 hover:scale-105 transition-all duration-300">
                    ...
                    <p className="text-muted-foreground test-sm mb-3">
                        {item.company}
                    </p>
