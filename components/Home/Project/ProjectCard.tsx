// components/Home/Project/ProjectCard.tsx 
...
const ProjectCard = ({
  ...
  return (
    <div className="group relative justify-center my-2 mx-6 h-120 w-70 gap-4 bg-white dark:bg-gray-800 shadow-md rounded-2xl overflow-hidden">
      {/* Image Container */}
